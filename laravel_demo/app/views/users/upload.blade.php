...
@section('content')
	<div class="col-xs-12 col-sm-9">
		<div class="list-group">
		 	<a href="#" class="list-group-item active">Trang Upload</a>
	        <div class="list-group-item">

					<form id='form-make' class='well' enctype="multipart/form-data" action="{{asset('upload')}}" method='post'>
						@if ($errors->any())
						...
						<div>
							...
							<input type='file' name='tailieu' id='tailieu' placeholder="Chọn tài liệu"  />
						</div>
						...
						<div>
							...
							<a href='{{asset("container")}}' >Quay về</a>
						</div>
					</form>
