	...
	<div class="container">
		<section class="section-padding">
			<div class="jumbotron text-center">
				<h1>Edit TaiLieu {{ $users-> id }}</h1>

				{{Form::open(['url'=>'/edit_users', 'class'=>'form'])}}
				...
				<div class="form-group">
					{{Form::label('ngayupload', 'Ngày Upload:')}}
					{{Form::text('ngayupload', $tailieu->created_at, ['class'=>'form-control'])}}
				</div>
